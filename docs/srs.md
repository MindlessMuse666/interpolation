<div align="center">
  ...
  <div style="display: flex; justify-content: center; gap: 8px; flex-wrap: wrap;">
    ...
    <img alt="Gin" src="https://img.shields.io/badge/Gin-1.9+-00ADD8?labelColor=00ADD8&logo=go&logoColor=white" />
...
```mermaid
graph LR
    Nginx["Nginx (статический сервер + обратный прокси)"] -->|HTTP| Gateway["API Gateway (Golang / Gin)"]
    Gateway -->|HTTP| Interpolation["Interpolation Service (Golang / Gin)"]
    Interpolation -->|Публикует событие| RabbitMQ["RabbitMQ"]
    RabbitMQ -->|Потребляет| History["History Service (Golang / Gin)"]
    History -->|Пишет/читает| SQLite[("SQLite")]
    Interpolation -->|Кеширует ответы| Redis[("Redis")]
```
...
erDiagram
    CALCULATION {
        INTEGER id PK "Первичный ключ, автоинкремент"
        TEXT method "Метод интерполяции (linear, lagrange, newton)"
        TEXT points "JSON-массив точек [{x, y}, ...]"
        REAL target_x "Целевой аргумент"
        REAL result "Вычисленное значение интерполяции"
...
<div align="center">
  <img src="data:image/svg+xml;base64," alt="Interpolation logo" width="60" height="60" />
</div>
