              ...
              <v-window-item value="theory">
                <div ref="theoryRoot">
                  ...
                  >
                    ...
                    <div v-if="section.imageSrc" class="theory-image-wrap mt-5">
                      <img
...
import imgWhatIsInterpolation from '../assets/интерполяция_восстановление_значений_между_узлами.png'
import imgLinearInterpolation from '../assets/линейная_интерполяция.png'
import imgLagrangePolynomial from '../assets/полином_лагранжа.png'
import imgNewtonPolynomial from '../assets/полином_ньютона.png'
...
const theorySections = [
  {
    ...
    imageSrc: imgWhatIsInterpolation,
    imageAlt: 'Интерполяция: восстановление значений между узлами'
  },
  {
    id: 'where-used',
...
\]</div>`,
    ...
    imageSrc: imgLinearInterpolation,
    imageAlt: 'Линейная интерполяция'
  },
  {
    id: 'lagrange',
...
\]</div>`,
    ...
    imageSrc: imgLagrangePolynomial,
    imageAlt: 'Полином Лагранжа'
  },
  {
    id: 'newton',
...
\]</div>`,
    ...
    imageSrc: imgNewtonPolynomial,
    imageAlt: 'Полином Ньютона'
  },
  {
    id: 'choice',
...
.notes-panels :deep(.v-expansion-panel-title)::after {
  display: none !important;
}
.notes-panels :deep(.v-expansion-panels--variant-accordion) {
  border-top: 0 !important;
}
.notes-panels :deep(.v-expansion-panel-text__wrapper) {
  border-top: 0 !important;
}
...
.notes-panels :deep(.v-expansion-panel-title__overlay) {
  opacity: 0 !important;
}
.notes-panels :deep(.v-expansion-panel-title__icon) {
  opacity: 0.9;
}
